...
public class TestClient {
	...
	throws Exception {
		...
		String host = "192.168.1.33";//args[0];
		...
		ar.setAuthProtocol(AccessRequest.AUTH_CHAP); // or AUTH_CHAP
		ar.addAttribute("NAS-Identifier", "this.is.my.nas-identifier.de");
		ar.addAttribute("NAS-IP-Address", "192.168.1.33");
